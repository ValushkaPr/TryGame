class Game {
    ...
    loop() {
        ...
        go('end', 'panel d-flex justify-content-center algin-items-center');
    }
...
applySkill() {
    for (let i = 1; i < this.game.elements.lenght; i++) {
        if(this.game.element[i].x < this.x + (this.w / 2)) {
            this.game.element[i].x += 15;
